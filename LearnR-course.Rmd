...
The `dim` function displays the number of rows and columns in the data frame. In the code cell, you will see the code to call the `dim` function with the `gender_data` data frame as the argument. Run the code to see what `dim` returns. `gender_data` is already loaded.
